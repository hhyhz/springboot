...
basedir=$WORKSPACE/jmeterTestReports/
...
pwd
sh jmeter.sh -JthreadNum=$threadCount -JrampUp=$rampUp -JDurationTime=$durationTime -n -t $WORKSPACE/testScript/$v1 -l $basedir/TestReport.jtl -e -o $basedir/TestReport_HTML
